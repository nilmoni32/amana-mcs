...
class CreateMonomineesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('monominees', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('mo_id')->index(); // for faster search 
            $table->string('name');
    ...
    {
        Schema::dropIfExists('monominees');
    }
}
