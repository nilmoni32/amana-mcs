...
<div class="row">
    <div class="col-12 mx-auto">
        <div class="tile">
            <h3 class="tile-title text-center">{{__('MO Account Details')}}</h3>
            <form action=" {{ route('MOcode.store') }} " method="POST" role="form" enctype="multipart/form-data">
                @csrf
                <hr>
                <div class="tile-body">
                    {{-- BM personal details --}}
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('mo_code') is-invalid @enderror" type="text"
                                        name="mo_code" id="mo_code" value="{{ old('mo_code') }}" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="bm_code" id="bm_code" class="form-control">
                                        @foreach($bms as $bm)
                                        <option></option>
                                        <option value="{{ $bm->bm_code }}">{{ $bm->name }}</option>
                                        @endforeach
                                    </select>
                                </div>  
                                <input type="hidden" name="bm_name" id="bm_name">
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="asm_code" id="asm_code" class="form-control">
                                        @foreach($asms as $asm)
                                        <option></option>
                                        <option value="{{ $asm->asm_code }}">{{ $asm->name }}</option>
                                        @endforeach
                                    </select>
                                </div>  
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="rsm_code" id="rsm_code" class="form-control">
                                        @foreach($rsms as $rsm)
                                        <option></option>
                                        <option value="{{ $rsm->rsm_code }}">{{ $rsm->name }}</option>
                                        @endforeach
                                    </select>
                                </div>  
