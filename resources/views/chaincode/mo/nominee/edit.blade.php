...
<div class="row">
    ...
    <div class="col-10 nominee-padding">
        <div class="tile">
            <h3 class="tile-title text-center">{{__('Edit MO Nominee Account Details')}}</h3>
            <form action=" {{ route('MOcode.nominee.update') }} " method="POST" role="form" enctype="multipart/form-data">
                @csrf
                <hr>
                <div class="tile-body">
                    {{-- BM personal details --}}
                    <fieldset class="form-group border p-3">
                        <legend class="w-auto px-2 h6">{{ __('MO\'s Nominee Personal Data') }}</legend>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label" for="name">{{ __('Full Name') }}<span class="text-danger"> *</span></label>
                                    <input class="form-control @error('name') is-invalid @enderror" type="text"
                                        name="name" id="name" value="{{ old('name', $moNominee->name) }}" autocomplete="off" required>
                                    @error('name') {{ $message }}@enderror
                                </div>                                
                                <input type="hidden" name="id" value="{{ $moNominee->id }}">
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('father_name') is-invalid @enderror" type="text"
                                        name="father_name" id="father_name" value="{{ old('father_name', $moNominee->father_name) }}" autocomplete="off">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('mother_name') is-invalid @enderror" type="text"
                                        name="mother_name" id="mother_name" value="{{ old('mother_name', $moNominee->mother_name) }}" autocomplete="off">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('husband_name') is-invalid @enderror" type="text"
                                        name="husband_name" id="husband_name" value="{{ old('husband_name', $moNominee->husband_name) }}" autocomplete="off">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control datetimepicker @error('date_of_birth') is-invalid @enderror" type="text"
                                        name="date_of_birth" id="date_of_birth" value="{{ old('date_of_birth', date('d-m-Y', strtotime($moNominee->date_of_birth ))) }}" placeholder="choose date (d-m-Y)" autocomplete="off">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('nid') is-invalid @enderror" type="text"
                                        name="nid" id="nid" value="{{ old('nid', $moNominee->nid) }}" autocomplete="off" required>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('email') is-invalid @enderror" type="email"
                                        name="email" id="email" value="{{ old('email', $moNominee->email) }}" autocomplete="off">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('contact_no') is-invalid @enderror" type="text"
                                        name="contact_no" id="contact_no" value="{{ old('contact_no', $moNominee->contact_no) }}" autocomplete="off" required>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('relation') is-invalid @enderror" type="text"
                                        name="relation" id="relation" value="{{ old('relation', $moNominee->relation) }}" autocomplete="off" required>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('relation_percentage') is-invalid @enderror" type="text"
                                        name="relation_percentage" id="relation_percentage" value="{{ old('relation_percentage', $moNominee->relation_percentage) }}" autocomplete="off" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-1">
                                    ...
                                    <textarea class="form-control" rows="4" name="present_address"
                                        id="present_address">{{ old('present_address', $moNominee->present_address) }}</textarea>
                                </div>
                                <div class="mt-0">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="4" name="permanent_address"
                                        id="permanent_address">{{ old('permanent_address', $moNominee->permanent_address) }}</textarea>
                                </div>                                
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-md-2 text-left">
                                @if($moNominee->photo)
                                <img src="{{ asset('/storage/images/'. $moNominee->photo)}}" width="150"
                                    id="uploadphoto">
                                @else                                
                ...
                <div class="tile-footer text-right">
                    ...
                    &nbsp;&nbsp;&nbsp;<a class="btn btn-danger" href="{{ route('MOcode.nominee.index', $mo->id) }}"><i
