...
<div class="row">
    <div class="col-md-2 nominee-padding">
        <div class="tile p-0">
            @include('chaincode.gm.includes.sidebar')
        </div>
    </div>
    <div class="col-10 mx-auto nominee-padding">
        <div class="tile">
            <h3 class="tile-title text-center">{{__('Edit GM Account Details')}}</h3>
            <form action=" {{ route('GMcode.update') }} " method="POST" role="form" enctype="multipart/form-data">
                @csrf
                <hr>
                <div class="tile-body">
                    {{-- BM personal details --}}
                    <fieldset class="form-group border p-3">
                        <legend class="w-auto px-2 h6">{{ __('GM\'s Personal Data') }}</legend>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label" for="gm_code">{{ __('GM Code') }}<span class="text-danger"> *</span></label>
                                    <input class="form-control @error('gm_code') is-invalid @enderror" type="text"
                                        name="gm_code" id="gm_code" value="{{ old('gm_code', $gm->gm_code) }}" required>
                                    @error('gm_code') {{ $message }}@enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    name="appointment_date" id="appointment_date" placeholder="choose date (d-m-Y)"
                                         value="{{ old('appointment_date', date('d-m-Y', strtotime($gm->appointment_date)) ) }}" autocomplete="off" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('name') is-invalid @enderror" type="text"
                                        name="name" id="name" value="{{ old('name', $gm->name) }}" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('father_name') is-invalid @enderror" type="text"
                                        name="father_name" id="father_name" value="{{ old('father_name', $gm->father_name) }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('husband_name') is-invalid @enderror" type="text"
                                        name="husband_name" id="husband_name" value="{{ old('husband_name', $gm->husband_name ) }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('mother_name') is-invalid @enderror" type="text"
                                        name="mother_name" id="mother_name" value="{{ old('mother_name', $gm->mother_name) }}">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control datetimepicker @error('date_of_birth') is-invalid @enderror" type="text"
                                        name="date_of_birth" id="date_of_birth" value="{{ old('date_of_birth', date('d-m-Y', strtotime($gm->date_of_birth ))) }}" 
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('contact_no') is-invalid @enderror" type="text"
                                        name="contact_no" id="contact_no" value="{{ old('contact_no', $gm->contact_no) }}" required>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('email') is-invalid @enderror" type="email"
                                        name="email" id="email" value="{{ old('email', $gm->email ) }}">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('nid') is-invalid @enderror" type="text"
                                        name="nid" id="nid" value="{{ old('nid', $gm->nid) }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-1">
                                    ...
                                    <textarea class="form-control" rows="4" name="present_address"
                                        id="present_address">{{ old('present_address', $gm->present_address) }}</textarea>
                                </div>
                                <div class="mt-0">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="4" name="permanent_address"
                                        id="permanent_address">{{ old('permanent_address',$gm->present_address) }}</textarea>
                                </div>                                
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-md-2 text-left">                                
                                @if($gm->photo)
                                <img src="{{ asset('/storage/images/'. $gm->photo)}}" width="150"
                                    id="uploadphoto">
                                @else                                
                    ...
                    {{-- GM others data such as branch name, MR no --}}
                    <fieldset class="form-group border p-3">
                        <legend class="w-auto px-2 h6">{{ __('GM\'s Others Data') }}</legend>
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control custom-select mt-15 @error('requirement_type') is-invalid @enderror"
                                        ...
                                        @php $check = $requirement == $gm->requirement_type ?
                                        'selected' : '';
                                        @endphp
                            ...
                            <input type="hidden" name="branch_name" id="branch_name" value="{{ $gm->branch_name }}">                                        
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="branch_code" id="branch_code" class="form-control">
                                        ...
                                        <option></option>
                                        @php $check = $branch->branch_code == $gm->branch_code ?
                                        'selected' : '';
                                        @endphp
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('mr_no') is-invalid @enderror" type="text"
                                        name="mr_no" id="mr_no" value="{{ old('mr_no', $gm->mr_no) }}">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('mr_amount') is-invalid @enderror" type="text"
                                        name="mr_amount" id="mr_amount" value="{{ old('mr_amount', $gm->mr_amount) }}">
                ...
                <div class="tile-footer text-right">
                    ...
                    &nbsp;&nbsp;&nbsp;<a class="btn btn-danger" href="{{ route('GMcode.index') }}"><i
