...
<div class="row">
    <div class="col-12 mx-auto">
        <div class="tile">
            <h3 class="tile-title text-center">{{__('GM Account Details')}}</h3>
            <form action=" {{ route('GMcode.store') }} " method="POST" role="form" enctype="multipart/form-data">
                @csrf
                <hr>
                <div class="tile-body">
                    {{-- GM personal details --}}
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('gm_code') is-invalid @enderror" type="text"
                                        name="gm_code" id="gm_code" value="{{ old('gm_code') }}" required>
