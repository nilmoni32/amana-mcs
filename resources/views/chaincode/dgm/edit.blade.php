...
<div class="row">
    ...
    <div class="col-10 mx-auto nominee-padding">
        <div class="tile">
            <h3 class="tile-title text-center">{{__('Edit DGM Account Details')}}</h3>
            <form action=" {{ route('DGMcode.update') }} " method="POST" role="form" enctype="multipart/form-data">
                @csrf
                <hr>
                <div class="tile-body">
                    {{-- BM personal details --}}
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('dgm_code') is-invalid @enderror" type="text"
                                        name="dgm_code" id="dgm_code" value="{{ old('dgm_code', $dgm->dgm_code) }}" required>
                                    @error('dgm_code') {{ $message }}@enderror
                                </div>
                                <input type="hidden" name="id" value="{{$dgm->id}}">
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    name="appointment_date" id="appointment_date" placeholder="choose date (d-m-Y)"
                                         value="{{ old('appointment_date', date('d-m-Y', strtotime($dgm->appointment_date)) ) }}" autocomplete="off" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('name') is-invalid @enderror" type="text"
                                        name="name" id="name" value="{{ old('name', $dgm->name) }}" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('father_name') is-invalid @enderror" type="text"
                                        name="father_name" id="father_name" value="{{ old('father_name', $dgm->father_name) }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('husband_name') is-invalid @enderror" type="text"
                                        name="husband_name" id="husband_name" value="{{ old('husband_name', $dgm->husband_name ) }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('mother_name') is-invalid @enderror" type="text"
                                        name="mother_name" id="mother_name" value="{{ old('mother_name', $dgm->mother_name) }}">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control datetimepicker @error('date_of_birth') is-invalid @enderror" type="text"
                                        name="date_of_birth" id="date_of_birth" value="{{ old('date_of_birth', date('d-m-Y', strtotime($dgm->date_of_birth ))) }}" 
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('contact_no') is-invalid @enderror" type="text"
                                        name="contact_no" id="contact_no" value="{{ old('contact_no', $dgm->contact_no) }}" required>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('email') is-invalid @enderror" type="email"
                                        name="email" id="email" value="{{ old('email', $dgm->email ) }}">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('nid') is-invalid @enderror" type="text"
                                        name="nid" id="nid" value="{{ old('nid', $dgm->nid) }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-1">
                                    ...
                                    <textarea class="form-control" rows="4" name="present_address"
                                        id="present_address">{{ old('present_address', $dgm->present_address) }}</textarea>
                                </div>
                                <div class="mt-0">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="4" name="permanent_address"
                                        id="permanent_address">{{ old('permanent_address',$dgm->present_address) }}</textarea>
                                </div>                                
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-md-2 text-left">                                
                                @if($dgm->photo)
                                <img src="{{ asset('/storage/images/'. $dgm->photo)}}" width="150"
                                    id="uploadphoto">
                                @else                                
                    ...
                    {{-- DGM chain code --}}
                    <fieldset class="form-group border p-3">
                        <legend class="w-auto px-2 h6">{{ __('DGM\'s Chain Code Data') }}</legend>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="gm_code" id="gm_code" class="form-control">
                                        @foreach($gms as $gm)
                                        <option></option>
                                        @php $check = $gm->gm_code == $dgm->gm_code ?
                                        'selected' : '';
                                        @endphp
                                ...
                                <input type="hidden" name="gm_name" id="gm_name" value="{{ $dgm->gm_name }}"> 
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-1">
                                    <label class="control-label" for="gm_code_change_notes">{{ __('GM Change Notes') }}</label>
                                    <textarea class="form-control" rows="1" name="gm_code_change_notes"
                                        id="gm_code_change_notes">{{ old('gm_code_change_notes', $dgm->gm_code_change_notes) }}</textarea>
                                </div>
                            </div>  
                        </div>
                    </fieldset>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control custom-select mt-15 @error('requirement_type') is-invalid @enderror"
                                        ...
                                        @php $check = $requirement == $dgm->requirement_type ?
                                        'selected' : '';
                                        @endphp
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('mr_no') is-invalid @enderror" type="text"
                                        name="mr_no" id="mr_no" value="{{ old('mr_no', $dgm->mr_no) }}">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('mr_amount') is-invalid @enderror" type="text"
                                        name="mr_amount" id="mr_amount" value="{{ old('mr_amount', $dgm->mr_amount) }}">
                                    @error('mr_amount') {{ $message }}@enderror
                                </div>
                            </div> 
                            <input type="hidden" name="branch_name" id="branch_name" value="{{ $dgm->branch_name }}">                                        
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="branch_code" id="branch_code" class="form-control">
                                        ...
                                        <option></option>
                                        @php $check = $branch->branch_code == $dgm->branch_code ?
                                        'selected' : '';
                                        @endphp
