...
<div class="row">
    ...
    <div class="col-10 mx-auto nominee-padding">
        <div class="tile">
            <h3 class="tile-title text-center">{{__('Edit RSM Account Details')}}</h3>
            <form action=" {{ route('RSMcode.update') }} " method="POST" role="form" enctype="multipart/form-data">
                @csrf
                <hr>
                <div class="tile-body">
                    {{-- BM personal details --}}
                    <fieldset class="form-group border p-3">
                        <legend class="w-auto px-2 h6">{{ __('RSM\'s Personal Data') }}</legend>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label" for="rsm_code">{{ __('RSM Code') }}<span class="text-danger"> *</span></label>
                                    <input class="form-control @error('rsm_code') is-invalid @enderror" type="text"
                                        name="rsm_code" id="rsm_code" value="{{ old('rsm_code', $rsm->rsm_code) }}" required>
                                    @error('rsm_code') {{ $message }}@enderror
                                </div>
                                <input type="hidden" name="id" value="{{$rsm->id}}">
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    name="appointment_date" id="appointment_date" placeholder="choose date (d-m-Y)"
                                         value="{{ old('appointment_date', date('d-m-Y', strtotime($rsm->appointment_date)) ) }}" autocomplete="off" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('name') is-invalid @enderror" type="text"
                                        name="name" id="name" value="{{ old('name', $rsm->name) }}" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('father_name') is-invalid @enderror" type="text"
                                        name="father_name" id="father_name" value="{{ old('father_name', $rsm->father_name) }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('husband_name') is-invalid @enderror" type="text"
                                        name="husband_name" id="husband_name" value="{{ old('husband_name', $rsm->husband_name ) }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('mother_name') is-invalid @enderror" type="text"
                                        name="mother_name" id="mother_name" value="{{ old('mother_name', $rsm->mother_name) }}">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control datetimepicker @error('date_of_birth') is-invalid @enderror" type="text"
                                        name="date_of_birth" id="date_of_birth" value="{{ old('date_of_birth', date('d-m-Y', strtotime($rsm->date_of_birth ))) }}" 
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('contact_no') is-invalid @enderror" type="text"
                                        name="contact_no" id="contact_no" value="{{ old('contact_no', $rsm->contact_no) }}" required>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('email') is-invalid @enderror" type="email"
                                        name="email" id="email" value="{{ old('email', $rsm->email ) }}">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('nid') is-invalid @enderror" type="text"
                                        name="nid" id="nid" value="{{ old('nid', $rsm->nid) }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-1">
                                    ...
                                    <textarea class="form-control" rows="4" name="present_address"
                                        id="present_address">{{ old('present_address', $rsm->present_address) }}</textarea>
                                </div>
                                <div class="mt-0">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="4" name="permanent_address"
                                        id="permanent_address">{{ old('permanent_address',$rsm->present_address) }}</textarea>
                                </div>                                
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-md-2 text-left">                                
                                @if($rsm->photo)
                                <img src="{{ asset('/storage/images/'. $rsm->photo)}}" width="150"
                                    id="uploadphoto">
                                @else                                
                    ...
                    {{-- RSM chain code --}}
                    <fieldset class="form-group border p-3">
                        <legend class="w-auto px-2 h6">{{ __('RSM\'s Chain Code Data') }}</legend>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="dgm_code" id="dgm_code" class="form-control">
                                        @foreach($dgms as $dgm)
                                        <option></option>
                                        @php $check = $dgm->dgm_code == $rsm->dgm_code ?
                                        'selected' : '';
                                        @endphp
                                ...
                                <input type="hidden" name="dgm_name" id="dgm_name" value="{{ $rsm->dgm_name }}">
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="gm_code" id="gm_code" class="form-control">
                                        @foreach($gms as $gm)
                                        <option></option>
                                        @php $check = $gm->gm_code == $rsm->gm_code ?
                                        'selected' : '';
                                        @endphp
                                ...
                                <input type="hidden" name="gm_name" id="gm_name" value="{{ $rsm->gm_name }}"> 
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-1">
                                    ...
                                    <textarea class="form-control" rows="3" name="dgm_code_change_notes"
                                        id="dgm_code_change_notes">{{ old('dgm_code_change_notes', $rsm->dgm_code_change_notes) }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-1">
                                    ...
                                    <textarea class="form-control" rows="3" name="gm_code_change_notes"
                                        id="gm_code_change_notes">{{ old('gm_code_change_notes', $rsm->gm_code_change_notes) }}</textarea>
                                </div>
                            </div>                            
                        </div>
                    </fieldset>
                    ...
                    <fieldset class="form-group border p-3">
                        <legend class="w-auto px-2 h6">{{ __('RSM\'s Others Data') }}</legend>
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control custom-select mt-15 @error('requirement_type') is-invalid @enderror"
                                        ...
                                        @php $check = $requirement == $rsm->requirement_type ?
                                        'selected' : '';
                                        @endphp
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('mr_no') is-invalid @enderror" type="text"
                                        name="mr_no" id="mr_no" value="{{ old('mr_no', $rsm->mr_no) }}">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('mr_amount') is-invalid @enderror" type="text"
                                        name="mr_amount" id="mr_amount" value="{{ old('mr_amount', $rsm->mr_amount) }}">
                                    @error('mr_amount') {{ $message }}@enderror
                                </div>
                            </div> 
                            <input type="hidden" name="branch_name" id="branch_name" value="{{ $rsm->branch_name }}">                                        
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="branch_code" id="branch_code" class="form-control">
                                        ...
                                        <option></option>
                                        @php $check = $branch->branch_code == $rsm->branch_code ?
                                        'selected' : '';
                                        @endphp
                ...
                <div class="tile-footer text-right">
                    ...
                    &nbsp;&nbsp;&nbsp;<a class="btn btn-danger" href="{{ route('RSMcode.index') }}"><i
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        //setting dgm name when an rsm option is selected.        
