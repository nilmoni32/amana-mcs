...
<div class="row">
    <div class="col-12 mx-auto">
        <div class="tile">
            <h3 class="tile-title text-center">{{__('RSM Account Details')}}</h3>
            <form action=" {{ route('RSMcode.store') }} " method="POST" role="form" enctype="multipart/form-data">
                @csrf
                <hr>
                <div class="tile-body">
                    {{-- BM personal details --}}
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('rsm_code') is-invalid @enderror" type="text"
                                        name="rsm_code" id="rsm_code" value="{{ old('rsm_code') }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="dgm_code" id="dgm_code" class="form-control">
                                        @foreach($dgms as $dgm)
                                        <option></option>
                                        <option value="{{ $dgm->dgm_code }}">{{ $dgm->name }}</option>
                                        @endforeach
                                    </select>
                                </div>  
