...
<div class="row">
    <div class="col-12 mx-auto">
        <div class="tile">
            <h3 class="tile-title text-center">{{__('ASM Account Details')}}</h3>
            <form action=" {{ route('ASMcode.store') }} " method="POST" role="form" enctype="multipart/form-data">
                @csrf
                <hr>
                <div class="tile-body">
                    {{-- BM personal details --}}
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('asm_code') is-invalid @enderror" type="text"
                                        name="asm_code" id="asm_code" value="{{ old('asm_code') }}" required>
