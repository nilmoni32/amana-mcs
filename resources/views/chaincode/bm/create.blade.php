...
<div class="row">
    <div class="col-12 mx-auto">
        <div class="tile">
            <h3 class="tile-title text-center">{{__('BM Account Details')}}</h3>
            <form action=" {{ route('BMcode.store') }} " method="POST" role="form" enctype="multipart/form-data">
                @csrf
                <hr>
                <div class="tile-body">
                    {{-- BM personal details --}}
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('bm_code') is-invalid @enderror" type="text"
                                        name="bm_code" id="bm_code" value="{{ old('bm_code') }}" required>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="asm_code" id="asm_code" class="form-control">
                                        @foreach($asms as $asm)
                                        <option></option>
                                        <option value="{{ $asm->asm_code }}">{{ $asm->asm_name }}</option>
                                        @endforeach
                                    </select>
                                </div>  
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="rsm_code" id="rsm_code" class="form-control">
                                        @foreach($rsms as $rsm)
                                        <option></option>
                                        <option value="{{ $rsm->rsm_code }}">{{ $rsm->rsm_name }}</option>
                                        @endforeach
                                    </select>
                                </div>  
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="dgm_code" id="dgm_code" class="form-control">
                                        @foreach($dgms as $dgm)
                                        <option></option>
                                        <option value="{{ $dgm->dgm_code }}">{{ $dgm->dgm_name }}</option>
                                        @endforeach
                                    </select>
                                </div>  
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="gm_code" id="gm_code" class="form-control">
                                        @foreach($gms as $gm)
                                        <option></option>
                                        <option value="{{ $gm->gm_code }}">{{ $gm->gm_name }}</option>
                                        @endforeach
                                    </select>
                                </div> 
