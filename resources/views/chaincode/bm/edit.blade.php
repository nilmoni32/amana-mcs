...
<div class="row">
    ...
    <div class="col-10 mx-auto nominee-padding">
        <div class="tile">
            <h3 class="tile-title text-center">{{__('Edit BM Account Details')}}</h3>
            <form action=" {{ route('BMcode.update') }} " method="POST" role="form" enctype="multipart/form-data">
                @csrf
                <hr>
                <div class="tile-body">
                    {{-- BM personal details --}}
                    <fieldset class="form-group border p-3">
                        <legend class="w-auto px-2 h6">{{ __('BM\'s Personal Data') }}</legend>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label" for="bm_code">{{ __('BM Code') }}<span class="text-danger"> *</span></label>
                                    <input class="form-control @error('bm_code') is-invalid @enderror" type="text"
                                        name="bm_code" id="bm_code" value="{{ old('bm_code', $bm->bm_code) }}" required>
                                    @error('bm_code') {{ $message }}@enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    name="appointment_date" id="appointment_date" placeholder="choose date (d-m-Y)"
                                         value="{{ old('appointment_date', date('d-m-Y', strtotime($bm->appointment_date)) ) }}" autocomplete="off" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('name') is-invalid @enderror" type="text"
                                        name="name" id="name" value="{{ old('name', $bm->name) }}" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('father_name') is-invalid @enderror" type="text"
                                        name="father_name" id="father_name" value="{{ old('father_name', $bm->father_name) }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('husband_name') is-invalid @enderror" type="text"
                                        name="husband_name" id="husband_name" value="{{ old('husband_name', $bm->husband_name ) }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('mother_name') is-invalid @enderror" type="text"
                                        name="mother_name" id="mother_name" value="{{ old('mother_name', $bm->mother_name) }}">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control datetimepicker @error('date_of_birth') is-invalid @enderror" type="text"
                                        name="date_of_birth" id="date_of_birth" value="{{ old('date_of_birth', date('d-m-Y', strtotime($bm->date_of_birth ))) }}" 
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('contact_no') is-invalid @enderror" type="text"
                                        name="contact_no" id="contact_no" value="{{ old('contact_no', $bm->contact_no) }}" required>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('email') is-invalid @enderror" type="email"
                                        name="email" id="email" value="{{ old('email', $bm->email ) }}">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('nid') is-invalid @enderror" type="text"
                                        name="nid" id="nid" value="{{ old('nid', $bm->nid) }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-1">
                                    ...
                                    <textarea class="form-control" rows="4" name="present_address"
                                        id="present_address">{{ old('present_address', $bm->present_address) }}</textarea>
                                </div>
                                <div class="mt-0">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="4" name="permanent_address"
                                        id="permanent_address">{{ old('permanent_address',$bm->present_address) }}</textarea>
                                </div>                                
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-md-2 text-left">                                
                                @if($bm->photo)
                                <img src="{{ asset('/storage/images/'. $bm->photo)}}" width="150"
                                    id="uploadphoto">
                                @else                                
                    ...
                    {{-- BM chain code --}}
                    <fieldset class="form-group border p-3">
                        <legend class="w-auto px-2 h6">{{ __('BM\'s Chain Code Data') }}</legend>
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-1">
                                    ...
                                    <textarea class="form-control" rows="3" name="asm_code_change_notes"
                                        id="asm_code_change_notes">{{ old('asm_code_change_notes', $bm->asm_code_change_notes) }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group mb-1">
                                    ...
                                    <textarea class="form-control" rows="3" name="rsm_code_change_notes"
                                        id="rsm_code_change_notes">{{ old('rsm_code_change_notes', $bm->rsm_code_change_notes) }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group mb-1">
                                    ...
                                    <textarea class="form-control" rows="3" name="dgm_code_change_notes"
                                        id="dgm_code_change_notes">{{ old('dgm_code_change_notes', $bm->dgm_code_change_notes) }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group mb-1">
                                    ...
                                    <textarea class="form-control" rows="3" name="gm_code_change_notes"
                                        id="gm_code_change_notes">{{ old('gm_code_change_notes', $bm->gm_code_change_notes) }}</textarea>
                                </div>
                            </div>
                    ...
                    <fieldset class="form-group border p-3">
                        <legend class="w-auto px-2 h6">{{ __('BM\'s Others Data') }}</legend>
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control custom-select mt-15 @error('requirement_type') is-invalid @enderror"
                                        ...
                                        @php $check = $requirement == $bm->requirement_type ?
                                        'selected' : '';
                                        @endphp
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('mr_no') is-invalid @enderror" type="text"
                                        name="mr_no" id="mr_no" value="{{ old('mr_no', $bm->mr_no) }}">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('mr_amount') is-invalid @enderror" type="text"
                                        name="mr_amount" id="mr_amount" value="{{ old('mr_amount', $bm->mr_amount) }}">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="branch_code" id="branch_code" class="form-control">
                                        ...
                                        <option></option>
                                        @php $check = $branch->branch_code == $bm->branch_code ?
                                        'selected' : '';
                                        @endphp
                ...
                <div class="tile-footer text-right">
                    ...
                    &nbsp;&nbsp;&nbsp;<a class="btn btn-danger" href="{{ route('BMcode.index') }}"><i
