...
<div class="row">
    ...
    <div class="col-10 nominee-padding">
        <div class="tile">
            <h3 class="tile-title text-center">{{__('BM Nominee Account Details')}}</h3>
            <form action=" {{ route('BMcode.nominee.store') }} " method="POST" role="form" enctype="multipart/form-data">
                @csrf
                <hr>
                <div class="tile-body">
                    {{-- BM personal details --}}
                    <fieldset class="form-group border p-3">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input type="hidden" name="bm_id" value="{{ $bm->id }}">
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
