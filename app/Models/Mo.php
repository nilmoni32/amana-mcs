...
class Mo extends Model
{
    ...
    * @var array
    */
    protected $fillable = ['mo_code','name', 'appointment_date','father_name', 'husband_name','mother_name','date_of_birth', 'contact_no',
   ...
   'dgm_code_change_notes', 'gm_code_change_notes', 'bm_code', 'bm_name', 'bm_code_change_notes'];
    ...
    */
    public function monominees(){
        return $this->hasMany(Monominee::class);
    }
}
